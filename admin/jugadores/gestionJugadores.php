...
<div class="admin-table-wrap">
    <table class="admin-table jugadores-table">
        ...
        <tbody>
            ...
            <tr>
                <td><img src="/inner-work/clash/assets/img/<?= htmlspecialchars($j['avatar']) ?>.png" class="tabla-avatar-img" alt="avatar"></td>
                <td><?= htmlspecialchars($j['nombre']) ?></td>
                <td><?= $j['pin'] ? htmlspecialchars($j['pin']) : '—' ?></td>
                <td><?= $j['categoria'] ? htmlspecialchars($j['categoria']) : '—' ?></td>
                <td>
                    <div class="admin-table-actions">
                        <a href="/inner-work/clash/admin/jugadores/bajaJugadorProc.php?id=<?= $j['id'] ?>"
