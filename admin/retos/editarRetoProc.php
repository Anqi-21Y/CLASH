...
//Actualizar un reto existente mediante una petición JSON
...
// Preparar la actualización de los datos del reto
$stmt = $db->prepare("UPDATE retos SET emojis = :emojis,
  op1_es = :o1, op1_ca = :o1, op1_zh = :o1,
  op2_es = :o2, op2_ca = :o2, op2_zh = :o2,
  op3_es = :o3, op3_ca = :o3, op3_zh = :o3,
  op4_es = :o4, op4_ca = :o4, op4_zh = :o4,
  opcion_correcta = :correcta WHERE id = :id");

// Vincular nuevos valore
